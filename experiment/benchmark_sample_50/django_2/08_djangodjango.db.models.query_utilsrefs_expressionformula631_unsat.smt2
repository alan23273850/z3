...
(assert (not (str.contains annotations "C__E")))
...
(assert (not (str.contains annotations "C__E__B")))
...
(assert (not (str.contains annotations "C__E__B__A")))
...
(assert (not (str.contains annotations "C__E__B__A__D")))
(assert (< 0 (str.len (str.substr lookup_parts 0 (- 6 0)))))
(assert (not (< 1 (str.len (str.substr lookup_parts 0 (- 6 0))))))
(check-sat)
