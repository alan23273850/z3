...
(assert (not (str.contains annotations "C__A")))
...
(assert (not (str.contains annotations "C__A__D")))
...
(assert (not (str.contains annotations "C__A__D__E")))
...
(assert (not (str.contains annotations "C__A__D__E__A")))
