...
(assert (= (str.++ "" needle) "<!"))
(assert (not (< (+ 0 (str.indexof (str.++ "" needle) "<" 0)) 0)))
(assert (not (< (+ (+ 0 (str.indexof (str.++ "" needle) "<" 0)) 4) 0)))
(assert (not (= (str.substr (str.++ "" needle) (+ 0 (str.indexof (str.++ "" needle) "<" 0)) (- (+ (+ 0 (str.indexof (str.++ "" needle) "<" 0)) 4) (+ 0 (str.indexof (str.++ "" needle) "<" 0)))) "<!--")))
(assert (not (< (+ 0 (str.indexof (str.++ "" needle) "<" 0)) 0)))
(assert (< (+ (+ 0 (str.indexof (str.++ "" needle) "<" 0)) 3) 0))
(check-sat)
(get-value (needle))
(get-value (haystack))
