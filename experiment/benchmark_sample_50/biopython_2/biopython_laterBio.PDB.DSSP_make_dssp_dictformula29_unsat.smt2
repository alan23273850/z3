...
(assert (not (< (+ (+ 0 (str.indexof (str.at handle 1) " " 0)) 1) 0)))
(assert (not (< (str.len (str.at handle 1)) 0)))
(assert (< (str.len (str.substr (str.at handle 1) (+ (+ 0 (str.indexof (str.at handle 1) " " 0)) 1) (- (str.len (str.at handle 1)) (+ (+ 0 (str.indexof (str.at handle 1) " " 0)) 1)))) 0))
(check-sat)
(get-value (handle))
