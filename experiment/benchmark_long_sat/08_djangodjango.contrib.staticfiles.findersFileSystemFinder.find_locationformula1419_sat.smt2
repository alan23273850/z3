...
(assert (= (str.substr (str.substr path 10 (- (str.len path) 10)) (+ (+ 0 (str.indexof (str.substr path 10 (- (str.len path) 10)) "/" 0)) 1) (- (str.len (str.substr path 10 (- (str.len path) 10))) (+ (+ 0 (str.indexof (str.substr path 10 (- (str.len path) 10)) "/" 0)) 1))) "."))
(assert (str.prefixof "/" (str.substr path 10 (- (str.len path) 10))))
