...
(assert (= (+ 0 (str.indexof (str.substr (str.substr path 10 (- (str.len path) 10)) (+ (+ 0 (str.indexof (str.substr path 10 (- (str.len path) 10)) "/" 0)) 1) (- (str.len (str.substr path 10 (- (str.len path) 10))) (+ (+ 0 (str.indexof (str.substr path 10 (- (str.len path) 10)) "/" 0)) 1))) "/" 0)) (- 1)))
(assert (= (str.substr (str.substr path 10 (- (str.len path) 10)) 0 (- (+ 0 (str.indexof (str.substr path 10 (- (str.len path) 10)) "/" 0)) 0)) ""))
(assert (not (= (str.substr (str.substr path 10 (- (str.len path) 10)) (+ (+ 0 (str.indexof (str.substr path 10 (- (str.len path) 10)) "/" 0)) 1) (- (str.len (str.substr path 10 (- (str.len path) 10))) (+ (+ 0 (str.indexof (str.substr path 10 (- (str.len path) 10)) "/" 0)) 1))) "")))
(assert (not (= (str.substr (str.substr path 10 (- (str.len path) 10)) (+ (+ 0 (str.indexof (str.substr path 10 (- (str.len path) 10)) "/" 0)) 1) (- (str.len (str.substr path 10 (- (str.len path) 10))) (+ (+ 0 (str.indexof (str.substr path 10 (- (str.len path) 10)) "/" 0)) 1))) ".")))
(assert (not (not (= (str.substr (str.substr path 10 (- (str.len path) 10)) (+ (+ 0 (str.indexof (str.substr path 10 (- (str.len path) 10)) "/" 0)) 1) (- (str.len (str.substr path 10 (- (str.len path) 10))) (+ (+ 0 (str.indexof (str.substr path 10 (- (str.len path) 10)) "/" 0)) 1))) ".."))))
(assert (str.prefixof "/" (str.substr path 10 (- (str.len path) 10))))
(assert (str.prefixof "/" (str.substr path 10 (- (str.len path) 10))))
(assert (not (< (str.len root) 0)))
(assert (str.prefixof "/" root))
(check-sat)
(get-value (root))
(get-value (path))
