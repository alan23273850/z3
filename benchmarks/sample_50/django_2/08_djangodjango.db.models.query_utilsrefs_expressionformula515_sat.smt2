...
(assert (not (str.contains annotations "C__B")))
...
(assert (not (str.contains annotations "C__B__A")))
...
(assert (not (str.contains annotations "C__B__A__E")))
...
(assert (not (< 4 (str.len (str.substr lookup_parts 0 (- 5 0))))))
(check-sat)
