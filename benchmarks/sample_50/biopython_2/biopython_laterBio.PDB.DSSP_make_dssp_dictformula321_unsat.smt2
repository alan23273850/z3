...
(assert (= (+ 0 (str.indexof (str.at handle 0) " " 0)) (- 1)))
...
(assert (not (= (+ 0 (str.indexof (str.at handle 2) " " 0)) (- 1))))
(assert (not (< (+ 0 (str.indexof (str.at handle 2) " " 0)) 0)))
(assert (not (< (+ (+ 0 (str.indexof (str.at handle 2) " " 0)) 1) 0)))
(assert (not (< (str.len (str.at handle 2)) 0)))
(assert (not (< (str.len (str.substr (str.at handle 2) (+ (+ 0 (str.indexof (str.at handle 2) " " 0)) 1) (- (str.len (str.at handle 2)) (+ (+ 0 (str.indexof (str.at handle 2) " " 0)) 1)))) 0)))
(assert (= (+ 0 (str.indexof (str.substr (str.at handle 2) (+ (+ 0 (str.indexof (str.at handle 2) " " 0)) 1) (- (str.len (str.at handle 2)) (+ (+ 0 (str.indexof (str.at handle 2) " " 0)) 1))) " " 0)) (- 1)))
...
(assert (not (< (+ 0 (str.indexof (str.at handle 5) " " 0)) 0)))
(assert (< (+ (+ 0 (str.indexof (str.at handle 5) " " 0)) 1) 0))
(check-sat)
(get-value (handle))
